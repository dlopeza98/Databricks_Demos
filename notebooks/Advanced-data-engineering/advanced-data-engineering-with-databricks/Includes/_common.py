...
course_config = CourseConfig(course_code = "adewd",
                             course_name = "advanced-data-engineering-with-databricks",
                            ...
                            #  supported_dbrs = ["12.2.x-scala2.12", "12.2.x-photon-scala2.12", "12.2.x-cpu-ml-scala2.12"],
                             supported_dbrs = ["13.3.x-scala2.12", "13.3.x-photon-scala2.12", "13.3.x-cpu-ml-scala2.12", "16.0.x-cpu-ml-scala2.12"],
                             expected_dbrs = "13.3.x-scala2.12, 13.3.x-photon-scala2.12, 13.3.x-cpu-ml-scala2.12, 16.0.x-cpu-ml-scala2.12")
